...
public class Config
{
    public static Vetor2 tamanhoMinSala = new Vetor2(6, 6), tamanhoMaxSala = new Vetor2(18, 18),
            tamanhoMaxDungeon = new Vetor2(80, 80), tamanhoMinDungeon = new Vetor2(25, 25), tamanhoMatrizZona = new Vetor2(15, 15),//tamanhoMatrizZona: numerosPares
    ...
    public static KeyCode cima = KeyCode.W, baixo = KeyCode.S, esquerda = KeyCode.A, direita = KeyCode.D, boost = KeyCode.LeftShift, interact = KeyCode.E;
